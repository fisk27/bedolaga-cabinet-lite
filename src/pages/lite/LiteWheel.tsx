          ...
          {rulesExpanded && (
            <div className="border-t border-white/[0.06] px-4 pb-3 pt-1.5">
              {[
                ...
                '🏆 Главные призы разыгрываются по 1 штуке в месяц среди всех участников',
                '🎁 При выигрыше главного приза выдаётся промокод — обратитесь в поддержку для получения',
              ].map((rule) => (
                <div
                  key={rule}
